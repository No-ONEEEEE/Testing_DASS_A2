"""Board layout, special tiles, and property lookup helpers for MoneyPoly."""
...
class Board:
    ...
    def _create_properties(self):
        ...
        g = self.groups
        return [
            Property(PropertyConfig("Mediterranean Avenue",   1,  60,  2),  g["brown"]),
            Property(PropertyConfig("Baltic Avenue",          3,  60,  4),  g["brown"]),
            Property(PropertyConfig("Oriental Avenue",        6,  100, 6),  g["light_blue"]),
            Property(PropertyConfig("Vermont Avenue",         8,  100, 6),  g["light_blue"]),
            Property(PropertyConfig("Connecticut Avenue",     9,  120, 8),  g["light_blue"]),
            Property(PropertyConfig("St. Charles Place",      11, 140, 10), g["pink"]),
            Property(PropertyConfig("States Avenue",          13, 140, 10), g["pink"]),
            Property(PropertyConfig("Virginia Avenue",        14, 160, 12), g["pink"]),
            Property(PropertyConfig("St. James Place",        16, 180, 14), g["orange"]),
            Property(PropertyConfig("Tennessee Avenue",       18, 180, 14), g["orange"]),
            Property(PropertyConfig("New York Avenue",        19, 200, 16), g["orange"]),
            Property(PropertyConfig("Kentucky Avenue",        21, 220, 18), g["red"]),
            Property(PropertyConfig("Indiana Avenue",         23, 220, 18), g["red"]),
            Property(PropertyConfig("Illinois Avenue",        24, 240, 20), g["red"]),
            Property(PropertyConfig("Atlantic Avenue",        26, 260, 22), g["yellow"]),
            Property(PropertyConfig("Ventnor Avenue",         27, 260, 22), g["yellow"]),
            Property(PropertyConfig("Marvin Gardens",         29, 280, 24), g["yellow"]),
            Property(PropertyConfig("Pacific Avenue",         31, 300, 26), g["green"]),
            Property(PropertyConfig("North Carolina Avenue",  32, 300, 26), g["green"]),
            Property(PropertyConfig("Pennsylvania Avenue",    34, 320, 28), g["green"]),
            Property(PropertyConfig("Park Place",             37, 350, 35), g["dark_blue"]),
            Property(PropertyConfig("Boardwalk",              39, 400, 50), g["dark_blue"]),
        ]
